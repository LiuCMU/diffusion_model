...
if __name__ == '__main__':
    ...
    for i in tqdm(range(config.epochs)):
        ...
        if i%10 == 0:
            torch.save(diffuser.model.state_dict(), os.path.join(folder, f'params/diffusion/con_pix32_diffusion{i}.pt'))
    ...
    torch.save(diffuser.model.state_dict(), os.path.join(folder, f'params/diffusion/con_pix32_final.pt'))
